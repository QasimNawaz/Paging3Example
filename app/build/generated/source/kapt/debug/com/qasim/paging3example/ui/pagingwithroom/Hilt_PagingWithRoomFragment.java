...
public abstract class Hilt_PagingWithRoomFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_PagingWithRoomFragment() {
    super();
  }

  Hilt_PagingWithRoomFragment(int contentLayoutId) {
  ...
  protected void inject() {
    ((PagingWithRoomFragment_GeneratedInjector) generatedComponent()).injectPagingWithRoomFragment(UnsafeCasts.<PagingWithRoomFragment>unsafeCast(this));
  }
